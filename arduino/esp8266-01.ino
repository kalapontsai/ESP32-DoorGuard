...
// 新增 /status endpoint，回傳 JSON 格式供 App 輪詢
void handleStatus() {
  String doorStatus = getDoorStatusString();
...
void setup() {
  ...
  server.on("/status", HTTP_GET, handleStatus);  // 新增 JSON status endpoint
